...
namespace MvcApplication4.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
            ...
            {
                new Category { Name = "kategoria1" },
                new Category { Name = "kategoria2" },
                new Category { Name = "kategoria3" },
            ...
            {
                new Note { Title = "Zgloszenie", Category = categories.Single(g => g.Name == "kategoria1"), Lng = 10,Lat=15 },
                new Note { Title = "Zgloszenie2", Category = categories.Single(g => g.Name == "kategoria2"), Lng = 10,Lat=15},
                new Note { Title = "Zgloszenie3", Category = categories.Single(g => g.Name =="kategoria3"), Lng = 10,Lat=15 },

            }; notes.ForEach(a => context.Notes.Add(a));
